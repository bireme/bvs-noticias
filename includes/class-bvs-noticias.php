...
class BVS_Noticias {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      BVS_Noticias_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - BVS_Noticias_Loader. Orchestrates the hooks of the plugin.
	 * - BVS_Noticias_i18n. Defines internationalization functionality.
	 * - BVS_Noticias_Admin. Defines all hooks for the admin area.
	 * - BVS_Noticias_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bvs-noticias-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bvs-noticias-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-bvs-noticias-admin.php';
	 ...
	 *
	 * Uses the BVS_Noticias_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new BVS_Noticias_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new BVS_Noticias_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    BVS_Noticias_Loader    Orchestrates the hooks of the plugin.
	 */
