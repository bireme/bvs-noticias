						...
						<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
				            ...
				            ?>
								<div class="entry-author">
									<strong class="entry-label"><?php _e('Author', 'bvs-noticias'); ?>:</strong>
				                <span class="entry-list"><?php echo $author; ?></span>
				              </div>
				            <?php endif; ?>
				            <?php
				            ...
				            ?>
								<div class="entry-publish-date">
									<strong class="entry-label"><?php _e('Publish Date', 'bvs-noticias'); ?>:</strong>
				                <span class="entry-list"><?php echo $publish_date; ?></span>
				              </div>
				            <?php endif; ?>
				            <?php
								...
								if ($source_url) :
				            ?>
								<div class="entry-source-url">
									<strong class="entry-label"><?php _e('Source URL', 'bvs-noticias'); ?>:</strong>
				                <span class="entry-list">
